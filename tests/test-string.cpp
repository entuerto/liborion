...
TestSuite(OrionCore_String)
{
   ...
   RegisterTestCase(OrionCore_String, string_by_character);
   RegisterTestCase(OrionCore_String, string_by_character_no_match);
   RegisterTestCase(OrionCore_String, string_by_string);
   RegisterTestCase(OrionCore_String, string_by_string_no_match);
   RegisterTestCase(OrionCore_String, string_tokenize);
   RegisterTestCase(OrionCore_String, string_tokenize_no_match);
   RegisterTestCase(OrionCore_String, string_join_string);
   RegisterTestCase(OrionCore_String, string_join_ints);
}
