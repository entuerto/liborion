...
module.exports = function(grunt) {
   ...
   grunt.registerMultiTask('configure', 'Configure build enviroment', function() {
      ...
      grunt.log.writeln();
      grunt.log.writeln(util.format("Configuration: (%s)", this.target));
      grunt.log.writeln()
