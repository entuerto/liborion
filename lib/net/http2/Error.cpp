...
static const std::map<ErrorCode, std::string> ErrorText{
   ...
   {ErrorCode::SettingsFrameSizeError, "Invalid SETTINGS frame with a length other than a multiple of 6 octets."},
   {ErrorCode::RstStreamInvalidStreamId, "Invalid stream id in RST_STREAM frame."},
   {ErrorCode::RstStreamFrameSizeError, "Invalid RST_STREAM frame with a length greater than 4."},
   {ErrorCode::PushPromiseInvalidStreamId, "Invalid stream id in PUSH_PROMISE frame."},
   {ErrorCode::GoAwayInvalidStreamId, "Invalid stream id in GOAWAY frame."},
   {ErrorCode::ContinuationInvalidStreamId, "Invalid stream id in CONTINUATION frame."},
   {ErrorCode::HeadersInvalidStreamId, "Invalid stream id in HEADERS frame."},
   {ErrorCode::TooManyStreams, "Too many open streams."},
