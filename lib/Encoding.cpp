...
uint32_t BigEndian::to_uint24(Span<const uint8_t> b)
{
   return static_cast<uint32_t>(b[2])      | 
          static_cast<uint32_t>(b[1]) << 8 |
          static_cast<uint32_t>(b[0]) << 16;
}
...
void BigEndian::put_uint24(uint32_t v, Span<uint8_t> b)
{
   b[0] = static_cast<uint8_t>(v >> 16);
   b[1] = static_cast<uint8_t>(v >> 8);
   b[2] = static_cast<uint8_t>(v);
}
...
uint32_t LittleEndian::to_uint24(Span<const uint8_t> b)
{
...
void LittleEndian::put_uint24(uint32_t v, Span<uint8_t> b)
{
   b[0] = static_cast<uint8_t>(v);
   b[1] = static_cast<uint8_t>(v >> 8);
