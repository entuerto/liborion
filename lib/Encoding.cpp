...
uint16_t BigEndian::to_uint16(const uint8_t* b)
{
   return uint16_t(b[1]) | uint16_t(b[0]) << 8;
}

uint32_t BigEndian::to_uint32(const uint8_t* b)
{
   return uint32_t(b[3]) | uint32_t(b[2]) << 8 | uint32_t(b[1]) << 16 | uint32_t(b[0]) << 24;
}

uint64_t BigEndian::to_uint64(const uint8_t* b)
{
...
uint16_t LittleEndian::to_uint16(const uint8_t* b)
{
   return uint16_t(b[0]) | uint16_t(b[1]) << 8;
}

uint32_t LittleEndian::to_uint32(const uint8_t* b)
{
   return uint32_t(b[0]) | uint32_t(b[1]) << 8 | uint32_t(b[2]) << 16 | uint32_t(b[3]) << 24;
}

uint64_t LittleEndian::to_uint64(const uint8_t* b)
{
