...
//
#ifndef ORION_DEBUG_DW_DWARFCONSTANTS_H
#define ORION_DEBUG_DW_DWARFCONSTANTS_H
...
///
/// AT::encoding constants (DWARF4 section 7.8 figure 25)
///
enum class ATE
{
   address         = 0x01,
...
///
/// AT::decimal_sign constants (DWARF4 section 7.8 figure 26)
///
enum class DS
{
   unsigned_          = 0x01,
...
///
/// AT::endianity constants (DWARF4 section 7.8 figure 27)
///
enum class END
{
   default_ = 0x00,
...
///
/// AT::accessibility constants (DWARF4 section 7.9 figure 28)
///
enum class ACCESS
{
   public_    = 0x01,
...
///
/// AT::visibility constants (DWARF4 section 7.10 figure 29)
///
enum class VIS
{
   local     = 0x01,
...
///
/// AT::language constants (DWARF4 section 7.12 figure 31)
///
enum class LANG
{
...
///
/// AT::identifier_case constants (DWARF4 section 7.14 figure 32)
///
enum class ID
{
   case_sensitive   = 0x00,
...
///
/// AT::calling_convention constants (DWARF4 section 7.15 figure 33)
///
enum class CC
{
   normal  = 0x01,
...
///
/// AT::inline constants (DWARF4 section 7.16 figure 34)
///
enum class INL
{
   not_inlined          = 0x00,
...
///
/// AT::ordering constants (DWARF4 section 7.17 figure 35)
///
enum class ORD
{
   row_major = 0x00,
...
///
/// AT::discr_list constants (DWARF4 section 7.18 figure 36)
///
enum class DSC
{
   label = 0x00,
...
#endif // ORION_DEBUG_DW_DWARFCONSTANTS_H
